...
You are at the end of the page, you can checkout my [previous work](/work), my [personal blog](https://blog.lexpeartha.com/) or [GitHub repository](https://github.com/Lexpeartha/portfolio) of this website and give it a [star]{class="sr-only"} :icon{name="ion:star" class="text-yellow-600"}
